...
RegisterNetEvent('mdx-dev:set_admins')
AddEventHandler('mdx-dev:set_admins', function(admins)
...
AddEventHandler('esx:playerLoaded', function()
    ESX.TriggerServerCallback('mdx-dev:getAdminsPlayers', function(admins)
        currentAdminPlayers = admins
    end)
end)
    ...
    while true do
        ...
        for k, v in pairs(visibleAdmins) do
            ...
            if playerServerID ~= -1 then
                ...
                local label = Config.StaffRankLabels[v.rank]
